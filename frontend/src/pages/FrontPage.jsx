  ...
  return (
    ...
    <div className="container">
      ...
      <div className="card">
        ...
        <img src="ResourcesImage.png" alt="Digital Resources" height="100"/>
      ...
      <div className="card">
        <h2>Gyms</h2>
        <img src="GymsImage.png" alt="Gyms" height="100"/>
    ...
    <div className="container6">
      <div className="card3">
        ...
        <ul>
          ...
          <li><a href="https://www.exerciseismedicine.org/eim-in-action/health-care/resources/rx-for-health-series/" target="_blank" rel="noopener noreferrer">when you have a medical condition</a> <a href="https://www.exerciseismedicine.org/eim-in-action/health-care/resources/rx-for-health-series/" target="_blank" rel="noopener noreferrer">(tenga una condición medica)</a></li>
