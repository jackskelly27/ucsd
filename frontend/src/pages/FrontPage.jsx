...
function FrontPage() {
  return (
    <>
    <Carousel>
      <CarouselItem><img src="RotatingImage1.png" alt="RotatingImage1" height="350px"/></CarouselItem>
      <CarouselItem><img src="RotatingImage2.png" alt="RotatingImage2" height="350px"/></CarouselItem>
      <CarouselItem><img src="RotatingImage3.png" alt="RotatingImage3" height="350px"/></CarouselItem>
      <CarouselItem><img src="RotatingImage4.png" alt="RotatingImage4" height="350px"/></CarouselItem>
      <CarouselItem><img src="RotatingImage5.png" alt="RotatingImage5" height="350px"/></CarouselItem>
    </Carousel>
