  ...
  return (
    ...
    <div className="container4">
      <div className="card2">
        ...
        <img src="Box1.png" alt="Welcome" height="180"/>
      </div>  
      <div className="card2">
        ...
        <img src="Box2.png" alt="Silver Sneakers" height="180"/>
      </div>
    </div>
    <div className="container">
      <div className="card">
        <h3>Physical Activities</h3>
        <img src="ActivitiesImage.png" alt="Physical Activities" height="180"/>
      ...
      <div className="card">
        ...
        <img src="DigitalResourcesNew.png" alt="Digital Resources" height="180"/>
      ...
      <div className="card">
        <h3>Gyms & Community Centers</h3>
        <img src="GymsImage.png" alt="Gyms" height="180"/>
